...
1. **任务计划系统**：家长设置计划任务（循环规则、日期规则、积分值），系统每日凌晨自动生成当日任务
...
- **儿童**：
  - 条件好：每人一个iPad/PAD
  - 条件不好：共用平板，4-6位PIN码登录，操作完毕后自动锁定
  - 15岁后：拥有手机，使用小程序

**数据流闭环**：

```
家长设置计划任务 → 系统每日凌晨生成当日任务 →
儿童标记完成/PIN登录 → 家长审批 →
积分结算（好任务+，坏任务-） →
...
**会话过期**：24小时自动刷新（Rolling Sessions）
...
**场景**：两个儿童共用一个平板，4-6位PIN码登录，操作完毕后自动锁定
...
- 妈妈需要**量化工具+情绪缓冲**，而不是简单计分
- 不同年龄段儿童需求差异大（3-6岁 vs 7-12岁 vs 15岁+）
- 15岁+青少年需要**隐私保护+自主权平衡**

**2. 场景化功能机会**

- **承诺协商机制**：不只是记录"答应了什么"，而是提供协商界面
- "妈妈，我完成了作业但今天有点累，可以少给我5分吗？"
- 孩子看到协商过程，学会"沟通和理解"
- **愿望层次化**：
  - 物品愿望 vs 体验愿望 vs 大额愿望
  - 系统可以帮助分类："这个需要1000分，那个需要300分"
- **情绪预警功能**：
  - 记录家长心情
